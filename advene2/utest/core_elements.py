...
class TestElements(TestCase):
    ...
    def _test_list_like(self, L, a, name):
        ...
        iter_idrefs = getattr(L, "iter_%s_idrefs" % name)
    ...
    def _test_with_tag(self, e):
        ...
        eq(idrefs((t1, t3), p), frozenset(e.iter_tag_idrefs(p)))
        eq(idrefs((t1, t2), p), frozenset(tm.iter_tag_idrefs(p)))
        eq(idrefs((t1,), p), frozenset(ta1.iter_tag_idrefs(p)))
        eq(idrefs((t2,), p), frozenset(ta2.iter_tag_idrefs(p)))
        ...
        eq(idrefs((t1, t3), p), frozenset(e.iter_tag_idrefs(p, 0)))
        eq(idrefs((t1, t2), p), frozenset(tm.iter_tag_idrefs(p, 0)))
        eq(idrefs((t1,), p), frozenset(ta1.iter_tag_idrefs(p, 0)))
        eq(idrefs((t2,), p), frozenset(ta2.iter_tag_idrefs(p, 0)))
        ...
        eq(idrefs((tm, ta1, e), p), frozenset(t1.iter_element_idrefs(p)))
        eq(idrefs((tm, ta2), p), frozenset(t2.iter_element_idrefs(p)))
        eq(idrefs((e,), p), frozenset(t3.iter_element_idrefs(p)))
        ...
        eq(idrefs((tm, ta1, e), p), frozenset(t1.iter_element_idrefs(p, 0)))
        eq(idrefs((tm, ta2), p), frozenset(t2.iter_element_idrefs(p, 0)))
        eq(idrefs((e,), p), frozenset(t3.iter_element_idrefs(p, 0)))
        ...
        eq(idrefs((t1, t2, t3), q), frozenset(e.iter_tag_idrefs(q)))
        eq(idrefs((t1, t2, t3), q), frozenset(tm.iter_tag_idrefs(q)))
        eq(idrefs((t1, t2), q), frozenset(ta1.iter_tag_idrefs(q)))
        eq(idrefs((t1, t2), q), frozenset(ta2.iter_tag_idrefs(q)))
        ...
        eq(idrefs((t2, t3), q), frozenset(e.iter_tag_idrefs(q, 0)))
        eq(idrefs((t3,), q), frozenset(tm.iter_tag_idrefs(q, 0)))
        eq(idrefs((t2,), q), frozenset(ta1.iter_tag_idrefs(q, 0)))
        eq(idrefs((t1,), q), frozenset(ta2.iter_tag_idrefs(q, 0)))
        ...
        eq(idrefs((tm, ta1, ta2, e), q), frozenset(t1.iter_element_idrefs(q)))
        eq(idrefs((tm, ta1, ta2, e), q), frozenset(t2.iter_element_idrefs(q)))
        eq(idrefs((tm, e), q), frozenset(t3.iter_element_idrefs(q)))
        ...
        eq(idrefs((ta2,), q), frozenset(t1.iter_element_idrefs(q, 0)))
        eq(idrefs((ta1, e), q), frozenset(t2.iter_element_idrefs(q, 0)))
        eq(idrefs((tm, e), q), frozenset(t3.iter_element_idrefs(q, 0)))
        ...
        eq(idrefs((t1,), p), frozenset(e.iter_tag_idrefs(p)))
        eq(frozenset((tm, e)), frozenset(t3.iter_elements(q)))
        eq(idrefs((tm, e), q), frozenset(t3.iter_element_idrefs(q)))
        eq(frozenset((tm, e)), frozenset(t3.iter_elements(q, 0)))
        eq(idrefs((tm, e), q), frozenset(t3.iter_element_idrefs(q, 0)))
        eq(frozenset(()), frozenset(t3.iter_elements(p)))
        eq(idrefs((), p), frozenset(t3.iter_element_idrefs(p)))
        ...
        eq(idrefs((t1, t2), q), frozenset(e.iter_tag_idrefs(q)))
        eq(frozenset((t2,)), frozenset(e.iter_tags(q, 0)))
        eq(idrefs((t2,), q), frozenset(e.iter_tag_idrefs(q, 0)))
        eq(frozenset((t1,)), frozenset(e.iter_tags(p)))
        eq(idrefs((t1,), p), frozenset(e.iter_tag_idrefs(p)))
        eq(frozenset((tm,)), frozenset(t3.iter_elements(q)))
        eq(idrefs((tm,), q), frozenset(t3.iter_element_idrefs(q)))
        eq(frozenset((tm,)), frozenset(t3.iter_elements(q, 0)))
        eq(idrefs((tm,), q), frozenset(t3.iter_element_idrefs(q, 0)))
        eq(frozenset(()), frozenset(t3.iter_elements(p)))
        eq(idrefs((), p), frozenset(t3.iter_element_idrefs(p)))
...
class TestUnreachable(TestCase):
    ...
    def test_member(self, exception_type):
        ...
        self.assertEquals(["a1", "p2:a2",], list(r.iter_member_idrefs()))
        p1.close()
    ...
    def test_item(self, exception_type):
        ...
        self.assertEquals(["a1", "p2:schema",], list(L.iter_item_idrefs()))
        p1.close()
    ...
    def test_tag(self, exception_type):
        ...
        self.assertEquals(frozenset(("t1", "p2:t2")),
                                    frozenset(a1.iter_tag_idrefs(p1)))
        self.assertEquals(frozenset((t1, "p2:t2")),
        ...
        self.assertEquals(frozenset(("a1", "p2:a2")),
                                    frozenset(t1.iter_element_idrefs(p1)))
        self.assertEquals(frozenset((a1, "p2:a2")),

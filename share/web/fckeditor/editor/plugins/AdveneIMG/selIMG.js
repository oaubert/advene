...
var req = "";
var sHtml = new String('<span contenteditable="false"><div class="AdveneContent" style="float: left\; height: 100px\; width: 100px\;" > contenu </div></span>');
...
sHtml = '<span contenteditable="false"><div class="AdveneContent"  style="float: left\; height: 200px\; width: 250px\;" ttal:repeat="a '+ req +'"><p style="text-align: center;">'
} else {
// annotation choisie
req = "here/annotations/"+a;
sHtml = '<span contenteditable="false"><div class="AdveneContent" style="float: left\; height: 200px\; width: 250px\;" ttal:define="a '+req+'"><p style="text-align:center;">'
}
if  (document.forms['frmMain'].link_img_vlc.checked)
{
        sHtml = sHtml + '<a title="'+document.forms['frmMain'].info_bulle_img.value+'" ttal:attributes="href a/player_url"><img alt="a/id" ttal:attributes="src a/snapshot_url" />';
...
sHtml = sHtml + '<img alt="a/id" ttal:attributes="src a/snapshot_url" /> ';
	if  (document.forms['frmMain'].titre.checked)
	{
		//affiche le nom 
